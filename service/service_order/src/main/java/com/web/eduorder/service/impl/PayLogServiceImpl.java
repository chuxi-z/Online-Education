...
import com.web.eduorder.Utils.HttpClient;
import com.web.eduorder.entity.Order;
import com.web.eduorder.entity.PayLog;
import com.web.eduorder.mapper.PayLogMapper;
...
public class PayLogServiceImpl extends ServiceImpl<PayLogMapper, PayLog> implements PayLogService {
    ...
    public Map<String, Object> createQR(String orderNo) {
        ...
        try {
            ...
            throw new customizeException(20001, "Fail to create QR code...");
        }
    }
